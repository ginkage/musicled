...
g++ -std=c++11 -Wall -Wextra -Wno-unused-result -Wno-maybe-uninitialized -g -O2 -Wl,-rpath /usr/local/lib -o stream musicled-streampp.o  -L/usr/local/lib -lpthread -lasound -lm -lfftw3 -ltinfo -lX11
