...
class Daubechies8 {
private:
    double scalingDecom[] { -0.010597401784997278, 0.032883011666982945, 0.030841381835986965,
        -0.18703481171888114, -0.02798376941698385, 0.6308807679295904, 0.7148465705525415,
        0.23037781330885523 };

    double waveletDecom[] { 0.23037781330885523, -0.7148465705525415, 0.6308807679295904,
